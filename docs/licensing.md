...
1. OSI open-source license (allows commercial use)
   - MIT / Apache-2.0 / GPLv3 / AGPLv3

2. Source-available non-commercial
...
Decide licensing strategy before the first public release and reflect it in:
